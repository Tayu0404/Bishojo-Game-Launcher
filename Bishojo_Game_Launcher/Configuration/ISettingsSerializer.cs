...
namespace BishojoGameLauncher.Configuration {
    ...
    /// <summary>設定情報を XML で出力する機能を提供します。</summary>
    /// <typeparam name="T">シリアライズするクラスの型。</typeparam>
    public class SettingsXmlSerializer<T> : ISettingsSerializer<T>
        where T : class {
        #region Members

        /// <summary>SettingsXmlSerializer クラスの新しいインスタンスを作成します。</summary>
    ...
    /// <typeparam name="T">シリアライズするクラスの型。</typeparam>
    public class SettingsJsonSerializer<T> : ISettingsSerializer<T>
        where T : class {
        #region Members

        /// <summary>SettingsJsonSerializer クラスの新しいインスタンスを作成します。</summary>
        public SettingsJsonSerializer() {
            KnownTypes = new List<Type>();
            MaxItemsInObjectGraph = Int32.MaxValue;
        }
    ...
    /// <typeparam name="T">シリアライズするクラスの型。</typeparam>
    public class SettingsBinarySerializer<T> : ISettingsSerializer<T>
        where T : class {
        #region Members

        /// <summary>SettingsBinarySerializer クラスの新しいインスタンスを作成します。</summary>
        ...
        public SettingsBinarySerializer(ISurrogateSelector selector, StreamingContext context) {
